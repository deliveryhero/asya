...
Source: greet_flow.py

DO NOT EDIT THIS FILE MANUALLY
Regenerate by running: asya flow compile greet_flow.py
"""
...
async def start_greet_flow(payload: dict):
    ...
    _next = []
    _next.append(resolve("router_greet_flow_line_17_seq_1"))
    yield "SET", ".route.next[:0]", _next
    yield payload

async def router_greet_flow_line_17_seq_1(payload: dict):
