...
Source: flow_text_improver.py

DO NOT EDIT THIS FILE MANUALLY
Regenerate by running: asya flow compile flow_text_improver.py
"""
...
async def router_text_improver_if_iteration_ge_max_iterations(payload: dict):
...
async def router_text_improver_if_score_ge_threshold(payload: dict):
    """Router for control flow and payload mutations"""
    p = payload
    _next = []
    if p['score'] >= p.get('threshold', 85):
        ...
        _next.append(resolve("router_text_improver_if_iteration_ge_max_iterations"))

    yield "SET", ".route.next[:0]", _next
    yield payload

async def router_text_improver_seq_set_iteration(payload: dict):
    """Router for control flow and payload mutations"""
    p = payload
    _next = []
...
async def router_text_improver_while_loop(payload: dict):
    """Router for control flow and payload mutations"""
    p = payload
    _next = []
