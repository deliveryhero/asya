...
Source: bare_script_flow.py

DO NOT EDIT THIS FILE MANUALLY
Regenerate by running: asya flow compile bare_script_flow.py
"""
...
async def start_bare_script_flow(payload: dict):
    """Entrypoint for flow 'bare_script_flow'"""
    _next = []
