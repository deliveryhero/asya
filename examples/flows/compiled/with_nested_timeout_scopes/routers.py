...
Source: with_nested_timeout_scopes.py

DO NOT EDIT THIS FILE MANUALLY
Regenerate by running: asya flow compile with_nested_timeout_scopes.py
"""
...
async def start_ingestion_pipeline(payload: dict):
    ...
    _next = []
    _next.append(resolve("data_fetcher"))
    _next.append(resolve("data_parser"))
    _next.append(resolve("data_validator"))
    _next.append(resolve("data_writer"))
