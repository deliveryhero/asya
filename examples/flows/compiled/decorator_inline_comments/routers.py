...
Source: decorator_inline_comments.py

DO NOT EDIT THIS FILE MANUALLY
Regenerate by running: asya flow compile decorator_inline_comments.py
"""
...
async def start_decorator_inline_comments_flow(payload: dict):
    ...
    _next.append(resolve("router_decorator_inline_comments_flow_if_category_eq_priority"))
    yield "SET", ".route.next[:0]", _next
    yield payload

async def router_decorator_inline_comments_flow_if_category_eq_priority(payload: dict):
