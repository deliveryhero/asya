...
async def start_while_mutations_in_loop_flow(payload: dict):
    ...
    _next.append(resolve("router_while_mutations_in_loop_flow_seq_set_i_2"))
    yield "SET", ".route.next[:0]", _next
    yield payload

async def router_while_mutations_in_loop_flow_seq_set_processed(payload: dict):
...
async def router_while_mutations_in_loop_flow_seq_set_i(payload: dict):
    """Router for control flow and payload mutations"""
    p = payload
    _next = []
    p['i'] += 1
    ...
    _next.append(resolve("router_while_mutations_in_loop_flow_seq_set_processed"))

    yield "SET", ".route.next[:0]", _next
    yield payload

async def router_while_mutations_in_loop_flow_while_i_lt_max_iterations(payload: dict):
    """Router for control flow and payload mutations"""
    p = payload
    _next = []
    if p['i'] < p['max_iterations']:
        _next.append(resolve("router_while_mutations_in_loop_flow_seq_set_i"))
        _next.append(resolve("router_while_mutations_in_loop_flow_while_i_lt_max_iterations"))
    else:
...
async def router_while_mutations_in_loop_flow_seq_set_i_2(payload: dict):
    """Router for control flow and payload mutations"""
    p = payload
    _next = []
    p['i'] = 0
