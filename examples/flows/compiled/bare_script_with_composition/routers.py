...
Source: bare_script_with_composition.py

DO NOT EDIT THIS FILE MANUALLY
Regenerate by running: asya flow compile bare_script_with_composition.py
"""
...
async def start_main_flow(payload: dict):
    """Entrypoint for flow 'main_flow'"""
    _next = []
