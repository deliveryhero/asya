...
async def start_while_with_continue_flow(payload: dict):
    ...
    _next.append(resolve("router_while_with_continue_flow_line_13_seq"))
    yield "SET", ".route.next[:0]", _next
    yield payload

async def router_while_with_continue_flow_line_16_if(payload: dict):
    """Router for control flow and payload mutations"""
    p = payload
    _next = []
    p['i'] += 1
    if p['skip_iteration']:
        _next.append(resolve("router_while_with_continue_flow_line_14_while_0"))
    else:
...
async def router_while_with_continue_flow_line_14_while_0(payload: dict):
    """Router for control flow and payload mutations"""
    p = payload
    _next = []
    if p['i'] < p['max_iterations']:
        _next.append(resolve("router_while_with_continue_flow_line_16_if"))
        _next.append(resolve("router_while_with_continue_flow_line_14_while_0"))
    else:
...
async def router_while_with_continue_flow_line_13_seq(payload: dict):
    """Router for control flow and payload mutations"""
    p = payload
    _next = []
    p['i'] = 0
