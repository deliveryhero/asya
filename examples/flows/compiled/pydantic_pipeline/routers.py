...
Source: ../../pydantic_pipeline.py

DO NOT EDIT THIS FILE MANUALLY
Regenerate by running: asya flow compile ../../pydantic_pipeline.py
"""
...
def start_pydantic_pipeline(payload: dict):
    """Entrypoint for flow 'pydantic_pipeline'"""
    _next = []
...
def end_pydantic_pipeline(payload: dict):
    """Exitpoint for flow 'pydantic_pipeline'"""
