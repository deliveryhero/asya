...
async def start_while_true_flow(payload: dict):
    ...
    _next.append(resolve("router_while_true_flow_line_14_while_1"))
    yield "SET", ".route.next[:0]", _next
    yield payload

async def router_while_true_flow_line_16_if_2(payload: dict):
...
async def router_while_true_flow_line_14_while_1(payload: dict):
    """Router for control flow and payload mutations"""
    p = payload
    _next = []
    _next.append(resolve("handler_process"))
    _next.append(resolve("router_while_true_flow_line_16_if_2"))
    _next.append(resolve("router_while_true_flow_line_14_while_1"))
