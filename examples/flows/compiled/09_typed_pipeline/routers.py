...
Source: 09_typed_pipeline.py

DO NOT EDIT THIS FILE MANUALLY
Regenerate by running: asya flow compile 09_typed_pipeline.py
"""
...
async def start_typeddict_pipeline(payload: dict):
    ...
    _next.append(resolve("router_typeddict_pipeline_if_not_valid"))
    yield "SET", ".route.next[:0]", _next
    yield payload

async def router_typeddict_pipeline_if_not_valid(payload: dict):
    """Router for control flow and payload mutations"""
    p = payload
    _next = []
    if not p.get('valid', True):
        yield "SET", ".route.next", [resolve("error_handler")]
        yield p
        return
    else:
