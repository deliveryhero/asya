...
async def start_if_all_empty_branches_flow(payload: dict):
    """Entrypoint for flow 'if_all_empty_branches_flow'"""
    _next = []
    _next.append(resolve("handler_setup"))
    _next.append(resolve("router_if_all_empty_branches_flow_if_skip_processing"))
    yield "SET", ".route.next[:0]", _next
    yield payload

async def router_if_all_empty_branches_flow_if_skip_processing(payload: dict):
