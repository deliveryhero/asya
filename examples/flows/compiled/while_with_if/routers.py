...
async def start_if_inside_while_flow(payload: dict):
    ...
    _next.append(resolve("router_if_inside_while_flow_seq_set_i"))
    yield "SET", ".route.next[:0]", _next
    yield payload

async def router_if_inside_while_flow_if_p_i_2_eq_0(payload: dict):
...
async def router_if_inside_while_flow_while_i_lt_max_iterations(payload: dict):
    """Router for control flow and payload mutations"""
    p = payload
    _next = []
    if p['i'] < p['max_iterations']:
        _next.append(resolve("router_if_inside_while_flow_if_p_i_2_eq_0"))
        _next.append(resolve("router_if_inside_while_flow_while_i_lt_max_iterations"))
    else:
...
async def router_if_inside_while_flow_seq_set_i(payload: dict):
    """Router for control flow and payload mutations"""
    p = payload
    _next = []
    p['i'] = 0
