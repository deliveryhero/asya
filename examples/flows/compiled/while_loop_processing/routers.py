...
async def start_loop_flow(payload: dict):
    ...
    _next.append(resolve("router_loop_flow_line_14_seq_7"))
    yield "SET", ".route.next[:0]", _next
    yield payload

async def router_loop_flow_line_26_if_2(payload: dict):
...
async def router_loop_flow_line_22_seq_3(payload: dict):
    """Router for control flow and payload mutations"""
    p = payload
    _next = []
    p['abort'] = 2
    _next.append(resolve("router_loop_flow_line_15_while_1"))
...
async def router_loop_flow_line_20_seq_4(payload: dict):
    ...
    _next.append(resolve("router_loop_flow_line_22_seq_3"))
...
async def router_loop_flow_line_19_if_5(payload: dict):
    ...
    if p.get('skip_threshold_check'):
        ...
        _next.append(resolve("router_loop_flow_line_26_if_2"))

    yield "SET", ".route.next[:0]", _next
    yield payload

async def router_loop_flow_line_16_seq_6(payload: dict):
    """Router for control flow and payload mutations"""
    p = payload
    _next = []
    p['iteration'] += 1
...
async def router_loop_flow_line_15_while_1(payload: dict):
    """Router for control flow and payload mutations"""
    p = payload
    _next = []
    if p['iteration'] < p['max_iterations']:
        _next.append(resolve("router_loop_flow_line_16_seq_6"))
        _next.append(resolve("router_loop_flow_line_15_while_1"))
    else:
        yield "SET", ".route.next", [resolve("finalize_loop")]
        yield p
...
async def router_loop_flow_line_14_seq_7(payload: dict):
    """Router for control flow and payload mutations"""
    p = payload
    _next = []
    p['iteration'] = 0
