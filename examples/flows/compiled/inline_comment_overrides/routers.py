...
Source: inline_comment_overrides.py

DO NOT EDIT THIS FILE MANUALLY
Regenerate by running: asya flow compile inline_comment_overrides.py
"""
...
async def end_order_pipeline(payload: dict):
    """Exitpoint for flow 'order_pipeline'"""
