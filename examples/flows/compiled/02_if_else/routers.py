...
Source: 02_if_else.py

DO NOT EDIT THIS FILE MANUALLY
Regenerate by running: asya flow compile 02_if_else.py
"""
...
async def start_if_else_simple_flow(payload: dict):
    ...
    _next.append(resolve("router_if_else_simple_flow_if_type_eq_a"))
    yield "SET", ".route.next[:0]", _next
    yield payload

async def router_if_else_simple_flow_if_type_eq_a(payload: dict):
