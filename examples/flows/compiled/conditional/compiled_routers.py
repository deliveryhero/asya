...
Source: /home/a.yushkovskiy/asya/examples/flows/conditional.py
Generated: 2025-12-13 22:38:38

DO NOT EDIT THIS FILE MANUALLY
Regenerate by running: asya flow compile /home/a.yushkovskiy/asya/examples/flows/conditional.py
"""
...
def start_conditional_flow(envelope: dict) -> dict:
    """Entrypoint for flow 'conditional_flow'"""
    r = envelope['route']
    c = r['current']

    r['actors'][c+1:c+1] = [resolve("handler_validate_input"), resolve("router_conditional_flow_line_11_if")]

    return envelope

def router_conditional_flow_line_13_seq(envelope: dict) -> dict:
    ...
    _next.append(resolve("end_conditional_flow"))

    r['actors'][c+1:c+1] = _next
    return envelope

def router_conditional_flow_line_16_seq(envelope: dict) -> dict:
    """Router for control flow and payload mutations"""
    p = envelope['payload']
    r = envelope['route']
    c = r['current']
...
def router_conditional_flow_line_19_seq(envelope: dict) -> dict:
    """Router for control flow and payload mutations"""
    p = envelope['payload']
    r = envelope['route']
    c = r['current']
...
def router_conditional_flow_line_14_if(envelope: dict) -> dict:
    """Router for control flow and payload mutations"""
    p = envelope['payload']
    r = envelope['route']
    c = r['current']
    ...
    if p['type'] == 'B':
        ...
        _next.append(resolve("router_conditional_flow_line_16_seq"))
    else:
        _next.append(resolve("handler_type_default"))
        _next.append(resolve("router_conditional_flow_line_19_seq"))

    r['actors'][c+1:c+1] = _next
    return envelope

def router_conditional_flow_line_11_if(envelope: dict) -> dict:
    """Router for control flow and payload mutations"""
    p = envelope['payload']
    r = envelope['route']
    c = r['current']
    ...
    if p['type'] == 'A':
        ...
        _next.append(resolve("router_conditional_flow_line_13_seq"))
    else:
        _next.append(resolve("router_conditional_flow_line_14_if"))

    r['actors'][c+1:c+1] = _next
    return envelope

def end_conditional_flow(envelope: dict) -> dict:
    """Exitpoint for flow 'conditional_flow'"""
    return envelope
