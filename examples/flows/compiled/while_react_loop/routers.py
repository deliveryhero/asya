...
async def start_react_agent(payload: dict):
    ...
    _next = []
    _next.append(resolve("router_react_agent_while_loop"))
    yield "SET", ".route.next[:0]", _next
    yield payload

async def router_react_agent_if_tool_calls(payload: dict):
...
async def router_react_agent_while_loop(payload: dict):
    """Router for control flow and payload mutations"""
    p = payload
    _next = []
    _next.append(resolve("llm_call"))
    _next.append(resolve("router_react_agent_if_tool_calls"))
    _next.append(resolve("router_react_agent_while_loop"))
