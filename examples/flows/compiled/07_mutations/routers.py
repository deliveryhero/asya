...
Source: 07_mutations.py

DO NOT EDIT THIS FILE MANUALLY
Regenerate by running: asya flow compile 07_mutations.py
"""
...
async def start_mutations_with_handler_flow(payload: dict):
    ...
    _next.append(resolve("router_mutations_with_handler_flow_seq_set_finalized"))
    yield "SET", ".route.next[:0]", _next
    yield payload

async def router_mutations_with_handler_flow_seq_set_finalized(payload: dict):
