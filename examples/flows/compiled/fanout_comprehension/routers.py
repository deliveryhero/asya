...
async def start_research_flow(payload: dict):
    ...
    _next.append(resolve("router_research_flow_fanout_results"))
    yield "SET", ".route.next[:0]", _next
    yield payload

async def router_research_flow_fanout_results(payload: dict):
    ...
    _agg = resolve("fanin_research_flow_results")
