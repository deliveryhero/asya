...
Source: tool_adapter.py

DO NOT EDIT THIS FILE MANUALLY
Regenerate by running: asya flow compile tool_adapter.py
"""
...
async def start_tool_adapter(payload: dict):
    """Entrypoint for flow 'tool_adapter'"""
    _next = []
    _next.append(resolve("validate_input"))
    _next.append(resolve("get_weather"))
    _next.append(resolve("format_greeting"))
    _next.append(resolve("compose_response"))
