...
async def start_mutations_before_after_handler_flow(payload: dict):
    ...
    _next.append(resolve("router_mutations_before_after_handler_flow_line_14_seq_2"))
    yield "SET", ".route.next[:0]", _next
    yield payload

async def router_mutations_before_after_handler_flow_line_16_seq_1(payload: dict):
    """Router for control flow and payload mutations"""
    p = payload
    p['step'] = 3
    yield p

async def router_mutations_before_after_handler_flow_line_14_seq_2(payload: dict):
    """Router for control flow and payload mutations"""
    p = payload
    _next = []
    p['step'] = 2
    _next.append(resolve("handler_b"))
    _next.append(resolve("router_mutations_before_after_handler_flow_line_16_seq_1"))
