...
Source: try_except_tuple_types.py

DO NOT EDIT THIS FILE MANUALLY
Regenerate by running: asya flow compile try_except_tuple_types.py
"""
...
async def router_ingestion_pipeline_line_16_seq_1(payload: dict):
...
async def router_ingestion_pipeline_line_15_except_2(payload: dict):
    """Router for error handling (except clause)"""
    yield "SET", ".route.next", [resolve('router_ingestion_pipeline_line_16_seq_1')]
    yield payload

async def router_ingestion_pipeline_line_19_seq_3(payload: dict):
    """Router for control flow and payload mutations"""
    p = payload
    _next = []
    p['status'] = 'bad_input'
...
async def router_ingestion_pipeline_line_18_except_4(payload: dict):
    """Router for error handling (except clause)"""
    yield "SET", ".route.next", [resolve('router_ingestion_pipeline_line_19_seq_3')]
    yield payload
