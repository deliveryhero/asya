...
Source: resiliency_tenacity_real.py

DO NOT EDIT THIS FILE MANUALLY
Regenerate by running: asya flow compile resiliency_tenacity_real.py
"""
...
async def start_api_pipeline(payload: dict):
    """Entrypoint for flow 'api_pipeline'"""
    p = payload
    _next = []
    p['status'] = 'started'
    _next.append(resolve("fetch_from_api"))
    _next.append(resolve("process_response"))
