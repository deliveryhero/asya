...
Source: try_except_fqn_types.py

DO NOT EDIT THIS FILE MANUALLY
Regenerate by running: asya flow compile try_except_fqn_types.py
"""
...
async def router_llm_pipeline_line_17_seq_1(payload: dict):
    ...
    _next = []
    p['fallback'] = True
    _next.append(resolve("call_fallback_llm"))
...
async def router_llm_pipeline_line_20_seq_3(payload: dict):
    ...
    _next.append(resolve("notify_admin"))
