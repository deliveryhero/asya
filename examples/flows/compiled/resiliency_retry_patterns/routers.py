...
Source: resiliency_retry_patterns.py

DO NOT EDIT THIS FILE MANUALLY
Regenerate by running: asya flow compile resiliency_retry_patterns.py
"""
...
async def start_llm_pipeline(payload: dict):
    ...
    _next.append(resolve("call_llm"))
    _next.append(resolve("parse_response"))
    _next.append(resolve("store_result"))
