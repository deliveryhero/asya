...
Source: actor_override_routing.py

DO NOT EDIT THIS FILE MANUALLY
Regenerate by running: asya flow compile actor_override_routing.py
"""
...
async def start_actor_override_flow(payload: dict):
    """Entrypoint for flow 'actor_override_flow'"""
    _next = []
    _next.append(resolve("classify"))
    _next.append(resolve("router_actor_override_flow_if_needs_tool"))
    yield "SET", ".route.next[:0]", _next
    yield payload

async def router_actor_override_flow_if_needs_tool(payload: dict):
    """Router for control flow and payload mutations"""
    p = payload
    _next = []
    if p.get('needs_tool'):
        _next.append(resolve("tool_executor"))
        _next.append(resolve("format_output"))
    else:
        _next.append(resolve("format_output"))
