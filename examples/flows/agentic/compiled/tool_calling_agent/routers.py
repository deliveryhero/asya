...
Source: tool_calling_agent.py

DO NOT EDIT THIS FILE MANUALLY
Regenerate by running: asya flow compile tool_calling_agent.py
"""
...
async def start_tool_calling_agent(payload: dict):
    """Entrypoint for flow 'tool_calling_agent'"""
    p = payload
    _next = []
...
async def router_tool_calling_agent_line_122_if_3(payload: dict):
    ...
    p = payload
    _next = []
    if p['tool_name'] == 'list_gcs_files':
        _next.append(resolve("list_gcs_files"))
    else:
        pass
