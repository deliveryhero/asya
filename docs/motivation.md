...
<img src="/docs/website/img/throughput-before.jpg" alt="Before: unacked messages accumulating, unstable throughput" style="max-width: 75%; border: 1px solid #9e9e9e; border-radius: 8px;"/>
...
<img src="/docs/website/img/actor-mesh.png" alt="Actor Mesh: all uniform, all async" style="max-width: 100%; border: 1px solid #9e9e9e; border-radius: 8px;"/>
...
<img src="/docs/website/img/throughput-after.jpg" alt="After: independent scaling per actor, stable throughput" style="max-width: 75%; border: 1px solid #9e9e9e; border-radius: 8px;"/>
