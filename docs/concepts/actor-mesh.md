...
<a href="/docs/website/img/actor-mesh.png" target="_blank" title="Click to view full size">
  <img src="/docs/website/img/actor-mesh.png" alt="Actor Mesh: actors connected through queues with independent KEDA scaling" style="max-width: 100%; cursor: zoom-in;"/>
</a>
