...
<!-- TEST: sleep 10 -->
<!-- TEST: kubectl logs -l asya.sh/asya=happy-end -n asya-system -c asya-runtime --tail=50 || echo "[!] No happy-end logs available" -->
<!-- TEST: kubectl logs -l asya.sh/asya=error-end -n asya-system -c asya-runtime --tail=50 || echo "[!] No error-end logs available" -->
