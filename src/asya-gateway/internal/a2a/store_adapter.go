...
func (a *StoreAdapter) Save(ctx context.Context, task *a2alib.Task, event a2alib.Event, prev *a2alib.Task, prevVersion a2alib.TaskVersion) (a2alib.TaskVersion, error) {
