...
func TestNewActorMeshage(t *testing.T) {
	tests := []struct {
		name         string
		task         *types.Task
		expectErr    bool
		validateMsg  func(*testing.T, ActorMeshage)
	...
	}{
		{
			...
			expectErr: false,
			validateMsg: func(t *testing.T, msg ActorMeshage) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			msg, err := NewActorMeshage(tt.task)
