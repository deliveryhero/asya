...
def resolve(handler_full_name: str) -> str:
    ...
    - ASYA_HANDLER_<ACTOR_NAME>="handler_name" or "ClassName.method"

    Environment variable names use underscores (dots and hyphens converted to underscores).
    The reverse mapping (handler -> actor) is built once at first call and cached.

    Args:
        handler_full_name: Full qualified name like "my_module.handler" or "my_module.ImageProcessor.process"
    ...
    Examples:
        ...
        # Module handler
        # Environment: ASYA_HANDLER_MY_ACTOR_NAME="module.submodule.handler"
        resolve("module.submodule.handler")  # returns "my-actor-name"
    """
    import os, logging
