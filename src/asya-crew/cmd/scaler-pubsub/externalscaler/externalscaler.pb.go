// KEDA External Scaler gRPC proto definition.
...
type MetricSpec struct {
	...
	TargetSize      int64                  `protobuf:"varint,2,opt,name=targetSize,proto3" json:"targetSize,omitempty"` // deprecated
...
type MetricValue struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	MetricName       string                 `protobuf:"bytes,1,opt,name=metricName,proto3" json:"metricName,omitempty"`
	MetricValue      int64                  `protobuf:"varint,2,opt,name=metricValue,proto3" json:"metricValue,omitempty"` // deprecated
