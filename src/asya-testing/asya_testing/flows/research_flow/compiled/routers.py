...
async def start_research_flow(payload: dict):
    ...
    _next = []
    _next.append(resolve("fanout_research_flow_line_6"))
    yield "SET", ".route.next[:0]", _next
    yield payload

async def fanout_research_flow_line_6(payload: dict):
    """Fan-out router: dispatches to sub-agents and aggregator (line 6)"""
    p = payload

    origin_id = yield "GET", ".id"
    _next_tail = yield "GET", ".route.next"

    _agg = resolve("fanin_research_flow_line_6")
