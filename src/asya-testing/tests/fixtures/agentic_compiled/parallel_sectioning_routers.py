...
async def start_parallel_sectioning(payload: dict):
    ...
    _next.append(resolve("router_parallel_sectioning_fanout_analysis"))
    yield "SET", ".route.next[:0]", _next
    yield payload

async def router_parallel_sectioning_fanout_analysis(payload: dict):
    ...
    _agg = resolve("fanin_parallel_sectioning_analysis")
