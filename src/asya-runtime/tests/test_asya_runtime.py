...
def call_invoke(meshage: dict, user_func) -> list[dict]:
    """Call _handle_invoke with a meshage dict and return response frames.
    ...
    """
    data = json.dumps(meshage).encode("utf-8")
...
def runtime_invoke(tmp_path):
    ...
    def _invoke(user_func, meshage):
        ...
        body = json.dumps(meshage).encode("utf-8")
        conn.request(
            "POST",
            "/invoke",
            body=body,
...
class TestHandlerReturnTypeValidation:
    ...
    def test_handler_returns_string_payload_mode(self):
        ...
        responses = call_invoke(meshage, string_handler)
    ...
    def test_handler_returns_number_payload_mode(self):
        ...
        responses = call_invoke(meshage, number_handler)
    ...
    def test_handler_returns_none_payload_mode(self):
        ...
        responses = call_invoke(meshage, none_handler)
    ...
    def test_handler_returns_empty_list(self):
        ...
        responses = call_invoke(meshage, empty_list_handler)
...
class TestRouteValidation:
    ...
    def test_parse_msg_route_not_dict(self):
        ...
        with pytest.raises(ValueError, match="Field 'route' must be a dict"):
            ...
            msg = asya_runtime._parse_meshage_json(data)
            asya_runtime._validate_meshage(msg)
    ...
    def test_parse_msg_route_valid_single_actor(self):
        ...
        msg = asya_runtime._parse_meshage_json(data)
        validated = asya_runtime._validate_meshage(msg)
...
class TestMeshageFieldPreservation:
    """Test that meshage fields are properly preserved through validation."""

    def test_validate_meshage_preserves_id_field(self):
        ...
        validated = asya_runtime._validate_meshage(meshage)

        assert validated["id"] == "message-123"
        assert validated["payload"] == {"test": "data"}
        assert validated["route"] == {"prev": [], "curr": "a", "next": []}

    def test_validate_meshage_preserves_parent_id_field(self):
    ...
    def test_validate_meshage_preserves_all_fields(self):
    ...
    def test_validate_meshage_preserves_status(self):
    ...
    def test_validate_meshage_without_id_field(self):
        """Test meshage without id field still validates (id is optional)."""
        meshage = {
            "payload": {"test": "data"},
            "route": {"prev": [], "curr": "a", "next": []},
        }
    ...
    def test_validate_meshage_id_field_invalid_type(self):
        ...
        with pytest.raises(ValueError, match="Field 'id' must be a string"):
            asya_runtime._validate_meshage(meshage)
    ...
    def test_vfs_handler_accesses_id_field(self):
        ...
        responses = call_invoke(meshage, abi_handler)
...
class TestAbiRouteModification:
    ...
    def test_abi_handler_modifies_next_allowed(self):
        ...
        responses = call_invoke(meshage, next_modifying_handler)
    ...
    def test_abi_handler_cannot_write_route_curr(self):
        ...
        responses = call_invoke(meshage, curr_writer)
    ...
    def test_abi_handler_cannot_write_route_prev(self):
        ...
        responses = call_invoke(meshage, prev_writer)
    ...
    def test_abi_handler_fanout_each_yields_with_next(self):
        ...
        responses = call_invoke(meshage, fanout_handler)
    ...
    def test_abi_handler_adds_future_actors_via_next(self):
        ...
        responses = call_invoke(meshage, extending_handler)
    ...
    def test_abi_handler_replaces_future_actors(self):
        ...
        responses = call_invoke(meshage, replacing_handler)
...
class TestLargePayloads:
    ...
    def test_large_payloads(self, size_kb):
        ...
        responses = call_invoke(meshage, echo_handler)
...
class TestParseMsg:
    """Test _parse_meshage_json and _validate_meshage functions."""
    ...
    def test_parse_msg_with_payload_and_route(self):
        ...
        msg = asya_runtime._parse_meshage_json(data)
        msg = asya_runtime._validate_meshage(msg)
    ...
    def test_parse_msg_invalid_json(self):
        ...
        with pytest.raises(json.JSONDecodeError):
            asya_runtime._parse_meshage_json(b"not json{")

    def test_parse_msg_invalid_utf8(self):
        """Test parsing invalid UTF-8."""
        with pytest.raises(UnicodeDecodeError):
            asya_runtime._parse_meshage_json(b"\xff\xfe invalid utf8")
...
class TestHandleRequestPayloadMode:
    ...
    def test_handle_request_success_single_output(self):
        ...
        responses = call_invoke(meshage, simple_handler)
    ...
    def test_handle_request_multi_actor_route(self):
        ...
        responses = call_invoke(meshage, pipeline_handler)
...
class TestHandleRequestVFSMode:
    ...
    def test_handle_request_route_modification_via_abi(self):
        ...
        responses = call_invoke(meshage, route_modifying_handler)
    ...
    def test_handle_request_abi_read_id(self):
        ...
        responses = call_invoke(meshage, id_reader)
...
class TestHandleRequestErrorCases:
    ...
    def test_handle_request_handler_exception(self):
        ...
        responses = call_invoke(meshage, failing_handler)
    ...
    def test_handle_request_generic_exception(self):
        ...
        responses = call_invoke(meshage, raising_handler)
    ...
    def test_class_handler_payload_mode(self, mock_env, tmp_path):
        ...
        try:
            with mock_env(ASYA_HANDLER="payload_class.PayloadProcessor.process"):
                ...
                responses = call_invoke(meshage, handler)
...
class TestAbiReadOnly:
    ...
    def test_abi_id_is_read_only(self):
        ...
        responses = call_invoke(meshage, id_writer)
    ...
    def test_abi_parent_id_is_read_only(self):
        ...
        responses = call_invoke(meshage, parent_id_writer)
    ...
    def test_abi_route_next_is_writable(self):
        ...
        responses = call_invoke(meshage, next_writer)
...
class TestEdgeCases:
    ...
    def test_handle_request_deeply_nested_json(self):
        ...
        meshage = {"payload": nested, "route": {"prev": [], "curr": "a", "next": []}}
    ...
    def test_handle_request_null_payload(self):
        ...
        meshage = {"payload": None, "route": {"prev": [], "curr": "a", "next": []}}
    ...
    def test_handler_raises_runtime_error(self):
        ...
        responses = call_invoke(meshage, error_handler)
    ...
    def test_handler_returns_complex_types(self):
        ...
        responses = call_invoke(meshage, complex_handler)
    ...
    def test_handler_returns_large_response(self):
        ...
        responses = call_invoke(meshage, large_handler)
...
class TestStatusPreservation:
    ...
    def test_abi_status_is_readable(self):
        ...
        responses = call_invoke(meshage, status_reader)
...
class TestHeadersPreservation:
    ...
    def test_headers_readable_via_abi(self):
        ...
        responses = call_invoke(meshage, header_reader)
...
class TestAbiHeaderAccess:
    ...
    def test_abi_headers_writable(self):
        ...
        responses = call_invoke(meshage, header_writer)
    ...
    def test_abi_missing_header_raises_key_error(self):
        ...
        responses = call_invoke(meshage, missing_header_reader)
...
class TestAsyncHandlers:
    ...
    def test_async_payload_mode_basic(self):
        ...
        responses = call_invoke(meshage, async_echo)
    ...
    def test_async_payload_mode_list_return(self):
        ...
        responses = call_invoke(meshage, async_list_return)
    ...
    def test_async_payload_mode_none_return(self):
        ...
        responses = call_invoke(meshage, async_none)
    ...
    def test_async_abi_header_access(self):
        ...
        responses = call_invoke(meshage, async_abi_handler)
    ...
    def test_async_handler_exception_produces_processing_error(self):
        ...
        responses = call_invoke(meshage, async_error)
    ...
    def test_sync_handler_still_works(self):
        ...
        responses = call_invoke(meshage, sync_handler)
    ...
    def test_async_class_method_handler(self):
        ...
        responses = call_invoke(meshage, processor.process)
    ...
    def test_async_handler_preserves_headers(self):
        ...
        responses = call_invoke(meshage, async_handler)
...
class TestAsyncGeneratorHandlers:
    ...
    def test_async_generator_fanout(self):
        ...
        responses = call_invoke(meshage, async_gen)
    ...
    def test_async_generator_yields_nothing_204(self):
        ...
        responses = call_invoke(meshage, empty_gen)
    ...
    def test_async_generator_with_abi_modification(self):
        ...
        responses = call_invoke(meshage, gen_with_abi)
    ...
    def test_async_generator_exception_midstream(self):
        ...
        responses = call_invoke(meshage, failing_gen)
    ...
    def test_async_generator_single_yield(self):
        ...
        responses = call_invoke(meshage, single_gen)
    ...
    def test_async_generator_preserves_headers(self):
        ...
        responses = call_invoke(meshage, gen)
...
class TestHTTPInvoke:
    ...
    def test_payload_mode_success(self, runtime_invoke):
        ...
        frames, status = runtime_invoke(handler, meshage)
        assert status == 200
        assert len(frames) == 1
    ...
    def test_payload_mode_preserves_headers(self, runtime_invoke):
        ...
        frames, status = runtime_invoke(lambda p: {"ok": True}, meshage)
        assert status == 200
    ...
    def test_async_handler(self, runtime_invoke):
        ...
        meshage = {"payload": {}, "route": {"prev": [], "curr": "a", "next": []}}
        frames, status = runtime_invoke(handler, meshage)
        assert status == 200
    ...
    def test_handler_returns_none_204(self, runtime_invoke):
        meshage = {"payload": {}, "route": {"prev": [], "curr": "a", "next": []}}
        frames, status = runtime_invoke(lambda p: None, meshage)
        assert status == 204
        assert frames == []
    ...
    def test_handler_exception_500(self, runtime_invoke):
        ...
        meshage = {"payload": {}, "route": {"prev": [], "curr": "a", "next": []}}
        error, status = runtime_invoke(bad_handler, meshage)
        assert status == 500
    ...
    def test_missing_payload_400(self, runtime_invoke):
        meshage = {"route": {"prev": [], "curr": "a", "next": []}}
        error, status = runtime_invoke(lambda p: p, meshage)
        assert status == 400
    ...
    def test_abi_id_access_success(self, tmp_path):
        ...
        meshage = {"id": "test-msg-id", "payload": {"x": 1}, "route": {"prev": [], "curr": "a", "next": []}}
    ...
    def test_large_payloads(self, runtime_invoke, size_kb):
        ...
        frames, status = runtime_invoke(lambda p: p, meshage)
        assert status == 200
...
class TestSSEStreaming:
    ...
    def test_sse_content_type(self, tmp_path):
        ...
        meshage = {"payload": {}, "route": {"prev": [], "curr": "a", "next": []}}
        status, ct, _ = self._invoke_raw(tmp_path, gen, meshage)
        assert status == 200
    ...
    def test_sse_downstream_events(self, tmp_path):
        ...
        meshage = {"payload": {}, "route": {"prev": [], "curr": "a", "next": ["b"]}}
        status, _, raw = self._invoke_raw(tmp_path, gen, meshage)
        assert status == 200
    ...
    def test_regular_handler_still_json(self, tmp_path):
        ...
        meshage = {"payload": {}, "route": {"prev": [], "curr": "a", "next": []}}
        status, ct, raw = self._invoke_raw(tmp_path, handler, meshage)
        assert status == 200
...
class TestAbiContext:
    ...
    def _make_meshage(self, **overrides):
        msg = {
            "id": "msg-1",
    ...
    def test_context_populates_from_message(self):
        ctx = asya_runtime._AbiContext(self._make_meshage())
    ...
    def test_context_with_status(self):
        msg = self._make_meshage(status={"error": {"type": "ValueError"}})
        ctx = asya_runtime._AbiContext(msg)
    ...
    def test_context_with_parent_id(self):
        msg = self._make_meshage(parent_id="parent-1")
        ctx = asya_runtime._AbiContext(msg)
