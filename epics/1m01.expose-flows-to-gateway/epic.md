...
- Dual-channel A2A Messages: FLY for streaming, envelope `history` for canonical turns
- A2A Context = envelope identity; multi-turn = pause-resume cycles
...
Related: 1c0d (A2A protocol), 1ixy (pause-resume), 1l01 (ABI), 1mx1 (envelope rename).
