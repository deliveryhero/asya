...
│       │   ├── configmap_routers.yaml  # router code ConfigMap
...
**base/kustomization.yaml** (generated by compiler — resources include
AsyncActor YAMLs + configmap_routers.yaml).
...
| `rfc-ui-components.md` | `@asya/ui` React component library, React Flow graph, provider pattern, anywidget/VSCode/web integration |
