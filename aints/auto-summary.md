...
# git-aint: 4 active, 82 open, 5 backlog | 245 merged
...
| Status | Ref | Pri | Title | Worktree | Branch | PR |
|--------|-----|-----|-------|----------|--------|----|
| ◐ active | [1kow] | P2 | E2E tests: full pipeline SLA and gateway backstop race | `.worktrees/timeout-handling/1kow.e2e-tests-full-pipeline-sla-gateway-backstop-race` | `timeout-handling/1kow.e2e-tests-full-pipeline-sla-gateway-backstop-race` | — |
