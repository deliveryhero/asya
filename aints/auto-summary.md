...
# git-aint: 8 active, 93 open, 3 backlog | 238 merged
...
| Status | Ref | Pri | Title | Worktree | Branch | PR |
|--------|-----|-----|-------|----------|--------|----|
| ◐ active | [p5nr] | P2 | docs: Add adapter-pattern tutorial | `.worktrees/handler-adapter-pattern/p5nr.docs-add-adapter-pattern-tutorial` | `handler-adapter-pattern/p5nr.docs-add-adapter-pattern-tutorial` | — |
