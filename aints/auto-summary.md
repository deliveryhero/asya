...
# git-aint: 7 active, 91 open, 1 pushed, 3 backlog | 236 merged
...
| ◑ pushed | [nqv1] | P2 | Design: S3 key lookup for GetTask history/artifacts | `.worktrees/a2a-protocol-compliance-gateway/nqv1.design-s3-key-lookup-gettask-history-artifacts` | `a2a-protocol-compliance-gateway/nqv1.design-s3-key-lookup-gettask-history-artifacts` | #265 |
...
| Status | Ref | Pri | Title | Worktree | Branch | PR |
|--------|-----|-----|-------|----------|--------|----|
| ○ open | [1fuy] | P2 | Implement authentication middleware | — | — | — |
