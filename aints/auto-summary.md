...
# git-aint: 7 active, 89 open, 1 pushed, 3 backlog | 240 merged
...
| Status | Ref | Pri | Title | Worktree | Branch | PR |
|--------|-----|-----|-------|----------|--------|----|
| ◐ active | [b51i] | P2 | Phase 2: MCP API key authentication | `.worktrees/agentic-security/b51i.phase-2-mcp-api-key-authentication` | `agentic-security/b51i.phase-2-mcp-api-key-authentication` | — |
...
| Status | Ref | Pri | Title | Worktree | Branch | PR |
|--------|-----|-----|-------|----------|--------|----|
| ◑ pushed | [p5nr] | P2 | docs: Add adapter-pattern tutorial | `.worktrees/handler-adapter-pattern/p5nr.docs-add-adapter-pattern-tutorial` | `handler-adapter-pattern/p5nr.docs-add-adapter-pattern-tutorial` | — |
