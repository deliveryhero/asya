...
# git-aint: 7 active, 89 open, 2 pushed, 3 backlog | 232 merged

## 1c0d/

| Status | Ref | Pri | Title | Worktree | Branch | PR |
|--------|-----|-----|-------|----------|--------|----|
| ◐ active | [j1oh] | P1 | Phase 1 Track A: DB migration and tool registry | — | — | #261 |
...
| Status | Ref | Pri | Title | Worktree | Branch | PR |
|--------|-----|-----|-------|----------|--------|----|
| ◐ active | [5vps] | P2 | A2A Phase 2: Tool Registry | — | — | #262 |
...
## redesign-protocol-sidecar-runtime/ — Send a test message
