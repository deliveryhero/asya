...
# git-aint: 3 active, 83 open, 2 pushed, 5 backlog | 246 merged
...
| Status | Ref | Pri | Title | Worktree | Branch | PR |
|--------|-----|-----|-------|----------|--------|----|
| ◐ active | [1f2y] | P2 | Crossplane E2E tech debt: DLQ support, drift detection tests, cold-start scaling | `.worktrees/tech-debt-crossplane-e2e-tests/1f2y.fix-scaling-performance-e2e-tests-cold-start-backlog` | `tech-debt-crossplane-e2e-tests/1f2y.fix-scaling-performance-e2e-tests-cold-start-backlog` | — |
