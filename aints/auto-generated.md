...
# git-aint: 4 active, 88 open, 2 pushed, 5 backlog | 249 merged
...
| ◐ active | [zaai] | P2 | Implement ConfigMap-based flow registry: YAML toolstore + Helm chart + RBAC (ADR impl) | `.worktrees/a2a-protocol-compliance-gateway/zaai.configmap-toolstore-adr-impl` | `a2a-protocol-compliance-gateway/zaai.configmap-toolstore-adr-impl` | — |
...
| Status | Ref | Pri | Title | Worktree | Branch | PR |
|--------|-----|-----|-------|----------|--------|----|
| ○ open | [wcnw] | P1 | K8s Secrets support for AsyncActor (v0) | — | — | — |
| ◐ active | [4iga] | P2 | Document gateway security model in docs/internal/ | `.worktrees/agentic-security/4iga.gateway-security-internal-docs` | `agentic-security/4iga.gateway-security-internal-docs` | #275 |
| ○ open | [1fdf] | P3 | External secrets integration: Vault, ESO, cloud secret managers (post-v0) | — | — | — |
...
| ◐ active | [1ffa] | P3 | Support scaling.advanced in Crossplane XRD | `.worktrees/debt/1ffa.support-scaling-advanced-crossplane-xrd` | `debt/1ffa.support-scaling-advanced-crossplane-xrd` | #276 |
...
| Status | Ref | Pri | Title | Worktree | Branch | PR |
|--------|-----|-----|-------|----------|--------|----|
| ○ open | [srn2] | P2 | Decorator detection and rule-based resolution in flow compiler | — | — | — |
| ○ open | [2t1q] | P2 | Support context managers (with/async with) in flow compiler | — | — | — |
| ○ open | [n67c] | P2 | Strip handler decorators by actors | — | — | — |
| ○ open | [xx8t] | P2 | Call-site decorator application: actor(handler)(p) pattern | — | — | — |
| ○ open | [pyn3] | P2 | Inline comment overrides for compiler rules (# asya: treat-as-*) | — | — | — |
...
### Recently closed
- ✓ merged [1f2y] fix-scaling-performance-e2e-tests-cold-start-backlog
