...
# git-aint: 3 active, 85 open, 9 pushed, 6 backlog | 258 merged
...
| Status | Ref | Pri | Title | Worktree | Branch | PR |
|--------|-----|-----|-------|----------|--------|----|
| ◐ active | [8gc6] | P2 | Phase 1: Remove leaked provider fields from XRD | `.worktrees/xrd-v2/8gc6.phase-1-remove-leaked-provider-fields-from-xrd` | `xrd-v2/8gc6.phase-1-remove-leaked-provider-fields-from-xrd` | — |
