...
# git-aint: 8 active, 87 open, 10 pushed, 4 backlog | 268 merged
...
| Status | Ref | Pri | Title | Worktree | Branch | PR |
|--------|-----|-----|-------|----------|--------|----|
| ◐ active | [ai6o] | P2 | Implement RFC flavor overlap rules: type-aware merge with conflict detection | `.worktrees/.worktrees/xrd-v2/ai6o.implement-rfc-flavor-overlap-rules-type-aware-merge` | `xrd-v2/ai6o.implement-rfc-flavor-overlap-rules-type-aware-merge` | #306 |

### Recently closed
- ✓ merged [lfcf] phase-2-flatten-workload-structure-promote-handler-rewrite
