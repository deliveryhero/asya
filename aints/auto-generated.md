...
# git-aint: 5 active, 85 open, 10 pushed, 5 backlog | 268 merged
...
| Status | Ref | Pri | Title | Worktree | Branch | PR |
|--------|-----|-----|-------|----------|--------|----|
| ◐ active | [i6o8] | P2 | Phase 5: Docker Compose CLI + socket transport | `.worktrees/.worktrees/asya-lab/i6o8.phase-5-docker-compose-cli-socket-transport` | `asya-lab/i6o8.phase-5-docker-compose-cli-socket-transport` | — |
