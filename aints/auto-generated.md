...
# git-aint: 3 active, 81 open, 8 pushed, 5 backlog | 250 merged
...
| Status | Ref | Pri | Title | Worktree | Branch | PR |
|--------|-----|-----|-------|----------|--------|----|
| ◐ active | [wcnw] | P1 | K8s Secrets support for AsyncActor (v0) | `.worktrees/agentic-security/wcnw.k8s-secrets-support-asyncactor-v0` | `agentic-security/wcnw.k8s-secrets-support-asyncactor-v0` | #282 |
...
| ○ open | [4v09] | P2 | Stealth mode: x-asya-mesh-status header to disable gateway task tracking | — | — | — |
