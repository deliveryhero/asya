...
# git-aint: 4 active, 83 open, 1 pushed, 5 backlog | 246 merged
...
| Status | Ref | Pri | Title | Worktree | Branch | PR |
|--------|-----|-----|-------|----------|--------|----|
| ◐ active | [q0la] | P2 | Fix e2e tests on main | `.worktrees/misc/q0la.fix-e2e-tests-main` | `misc/q0la.fix-e2e-tests-main` | — |
