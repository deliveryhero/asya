...
# git-aint: 3 active, 80 open, 8 pushed, 5 backlog | 258 merged
...
| Status | Ref | Pri | Title | Worktree | Branch | PR |
|--------|-----|-----|-------|----------|--------|----|
| ◐ active | [u5pd] | P2 | Simplify flavor function and fix stateProxy asymmetry | `.worktrees/.worktrees/debt/u5pd.fix-composition-assymetry-stateproxy` | `debt/u5pd.fix-composition-assymetry-stateproxy` | — |
