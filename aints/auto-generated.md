...
# git-aint: 5 active, 92 open, 10 pushed, 5 backlog | 260 merged
...
| Status | Ref | Pri | Title | Worktree | Branch | PR |
|--------|-----|-----|-------|----------|--------|----|
| ◐ active | [5ifn] | P2 | Phase 3: Local CLI (compile, expose, show, status) | `.worktrees/.worktrees/asya-lab/5ifn.phase-3-local-cli-compile-expose-show-status` | `asya-lab/5ifn.phase-3-local-cli-compile-expose-show-status` | #297 |
