...
## RFC: Binary Protocol (TLV + Marshal)
...
* **Type Safety:** `marshal` supports primary types (dict, list, str, bytes, float). Custom user classes must be converted to dicts before transit (standard for actor meshes).
...
#### 8.2 Go-to-Python Marshal Encoder
...
### 10. Summary of Tradeoffs & Breakpoints
...
### 11. Proposed Implementation Logic for LLM Generation
...
#### 12.1 The Stability of Marshal Versions
...
#### 12.2 The Probability of "Agreement without Compatibility"
...
#### 12.3 Comparison of Failure Modes
...
#### 12.4 Making it "Bulletproof" for asya.sh
...
### 13. Alternative -- Custom Binary Format
...
#### 13.1 The Strategy: The "Enveloped" Binary Stream
...
#### 13.2 Why this is superior to "Header|Delimiter|Body"
...
#### 13.3 Comparison of Custom Framing vs. MQ Headers
...
#### 13.4 Implementation Code Snippets
...
#### 13.5 Final Critical Verdict for asya.sh
...
### 14. Risks of Custom Binary Format
...
#### 14.1 The "OOM" (Out of Memory) Vulnerability
...
#### 14.2 "The Black Box" Problem (Observability)
...
#### 14.4 Marshalling & Deserialization Attacks
...
#### 14.5 Comparison of Risks vs. Rewards
...
#### 14.6 Final Memo Summary Recommendation
