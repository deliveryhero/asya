...
def test_database_connection_recovery(e2e_helper):
    ...
    try:
        ...
        assert e2e_helper.wait_for_pod_ready("app.kubernetes.io/name=postgresql", timeout=60)
        ...
        e2e_helper.kubectl("scale", "statefulset", "asya-gateway-postgresql", "--replicas=1")
        e2e_helper.wait_for_pod_ready("app.kubernetes.io/name=postgresql", timeout=60)
