...
from asya_testing.utils.s3 import delete_all_objects_in_bucket, wait_for_meshage_in_s3
...
def test_x_sink_persists_to_s3_e2e(e2e_helper, transport_timeouts):
    ...
    s3_object = wait_for_meshage_in_s3(RESULTS_BUCKET, task_id, timeout=5)
...
def test_x_sump_persists_to_s3_e2e(e2e_helper, transport_timeouts):
    ...
    s3_object = wait_for_meshage_in_s3(ERRORS_BUCKET, task_id, timeout=5)
