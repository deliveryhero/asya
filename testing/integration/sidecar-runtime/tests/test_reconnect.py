...
def test_runtime_restart_reconnects(transport_helper, docker_helper):
    ...
    transport_helper.publish_meshage("asya-default-test-echo", message_before)

    result_before = transport_helper.assert_meshage_in_queue("asya-default-x-sink", timeout=10)
    ...
    transport_helper.publish_meshage("asya-default-test-echo", message_after)

    result_after = transport_helper.assert_meshage_in_queue("asya-default-x-sink", timeout=15)
...
def test_runtime_crash_during_processing(transport_helper, docker_helper):
    ...
    transport_helper.publish_meshage("asya-default-test-timeout", message_slow)
    ...
    transport_helper.publish_meshage("asya-default-test-timeout", message_new)

    result = transport_helper.assert_meshage_in_queue("asya-default-x-sink", timeout=15)
